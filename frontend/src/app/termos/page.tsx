...
export const metadata = { title: "Termos de Uso — Onseg" };
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <article className="prose prose-sm max-w-none dark:prose-invert">
        ...
        <p>
          Ao criar uma conta e utilizar o Onseg ("Sistema", "Plataforma"), você ("Cliente", "Usuário")
        ...
        <h2>2. O que é o Onseg</h2>
        <p>
          O Onseg é um sistema de gestão (ERP) em nuvem, voltado para empresas do setor de construção
          civil, oferecendo módulos de gestão de clientes, instalações, orçamentos, vendas, compras, estoque,
        ...
        <p>
          ...
          Cliente. O Onseg atua como operador desses dados. O Cliente é o único responsável por garantir
        ...
        <p>
          O Onseg envida esforços razoáveis para manter o Sistema disponível continuamente, mas não
        ...
        <p>
          O Sistema, seu código-fonte, design e marca são de propriedade do Onseg. Estes Termos não
        ...
        <p>
          O Sistema é fornecido "como está". Na máxima extensão permitida pela lei, o Onseg não se
        ...
        <h2>11. Rescisão</h2>
        <p>
          O Cliente pode encerrar sua conta a qualquer momento. O Onseg pode suspender contas que
        ...
        <p>
          O Onseg pode atualizar estes Termos periodicamente, comunicando alterações relevantes com
        ...
        <h2>14. Contato</h2>
        <p>Em caso de dúvidas: contato@onseg.com.br</p>
      </article>
    </div>
  );
}
