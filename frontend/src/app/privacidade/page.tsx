...
export const metadata = { title: "Política de Privacidade — Construtec" };
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <article className="prose prose-sm max-w-none dark:prose-invert">
        <h1>Política de Privacidade e Cookies — Construtec</h1>
        ...
        <p>
          ...
          no Sistema, o Construtec atua como <strong>Operador</strong> — você é o <strong>Controlador</strong>,
          responsável por ter base legal para coletar esses dados. Quando tratamos dados da própria empresa
          Cliente e de seus usuários, o Construtec atua como Controlador.
        </p>
        ...
        <p>
          O Construtec <strong>não usa cookies de publicidade, rastreamento de terceiros ou analytics de
        ...
        <p>
          ...
          consentimento. Para exercer esses direitos: contato@construtec.com.br
        </p>
        <p>
          Quando o Construtec atua como Operador, solicitações devem ser direcionadas primeiro à empresa
        ...
        <h2>11. Contato</h2>
        <p>Dúvidas sobre esta Política: contato@construtec.com.br</p>
      </article>
    </div>
  );
}
