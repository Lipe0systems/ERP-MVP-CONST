...
const navPrincipal: NavItemDef = { href: "/dashboard", label: "Visão geral", icon: LayoutDashboard };
...
const navGrupos: NavGrupo[] = [
  ...
  },
  {
    titulo: "Financeiro",
    itens: [
      { href: "/financeiro", label: "Contas", icon: Wallet },
      { href: "/banco", label: "Fluxo de caixa", icon: Landmark },
    ],
  },
  {
    titulo: "Suprimentos",
  ...
  },
  {
    titulo: "Gestão",
    itens: [
      { href: "/rh", label: "RH", icon: Briefcase },
 ...
 */
function NavItem({ href, label, icon: Icon, active, onClick, recolhida }: {
  ...
  return (
    ...
    >
      {/* Barra indicadora à esquerda — sólida, sem gradiente */}
      <span
        className={cn(
