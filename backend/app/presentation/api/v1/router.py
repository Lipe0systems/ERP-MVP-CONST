...
from app.presentation.api.v1 import auth, clientes, compras, dashboard, diario_obra, estoque, financeiro, fornecedores, obras, onboarding, orcamentos, relatorios
