...
from app.presentation.api.v1 import auth, banco, clientes, compras, dashboard, diario_obra, documentos, estoque, financeiro, fornecedores, obras, onboarding, orcamentos, relatorios
