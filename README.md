...
> Esta seção pressupõe terminal com Python/Node instalados. Se você está fazendo o **deploy direto pelo navegador** (sem terminal), pule para `docs/DEPLOY.md` — ele cobre GitHub, Supabase, Render e Vercel 100% via painel web, incluindo `docs/schema.sql` como alternativa ao `alembic upgrade head` abaixo.
